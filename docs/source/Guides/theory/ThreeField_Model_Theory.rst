...
Implemented in the class: ThreeFieldSolver
Key methods:
ThreeFieldSolver.solve_mass_conservation()
ThreeFieldSolver.solve_momentum_conservation()
ThreeFieldSolver.solve_energy_conservation()
Properties:
ThreeFieldSolver.mass_flow_rate_film
ThreeFieldSolver.velocity_film
ThreeFieldSolver.velocity_drops
ThreeFieldSolver.film_thickness
ThreeFieldSolver.heat_flux_wall
...
Next: fourfield_model_theory.html
