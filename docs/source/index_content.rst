...
These frameworks include a mixture solver, a two-fluid solver, a three-field solver, and an advanced four-field solver of annular two-phase flow (:cite:t:`LECORREMODEL`). The implemented models support single-component, thermally expandable, steady-state and transient boiling two-phase flows in single straight channels developed under reasonable simplifying assumptions. Basic closure models have been implemented, subject to future improvements.
