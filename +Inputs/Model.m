classdef Model < Inputs.Input
    ...
    properties (SetAccess=?Inputs.Input)
        ...
        KLOC             (1,:) double  {mustBeNumeric,mustBeNonempty}      = [0]                             % Elevation of local perturbations [m]
        ...
        CBTKEFFECT       (1,2) double  {mustBeNumeric}                     = 0                               % Grid effect coefficients (:math:`1 + C(1) \exp(C(2) z)`) [-]
        ...
        KLOSS            (1,:) double  {mustBeNumeric,mustBeNonempty}      = 0                               % Pressure loss coefficients of local perturbations [-]
        ...
        KBLOCKRATIO      (1,:) double  {mustBeNumeric,mustBeNonempty}      = 0                               % Blockage ratios of local perturbations [-]
        KTUNING          (1,:) double  {mustBeNumeric,mustBeNonempty}      = 0                               % Drop deposition enhancement tuning coefficients [-]
