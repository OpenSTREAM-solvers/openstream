classdef Model < Inputs.Input
    ...
    properties (SetAccess=protected)
        ...
        OKAWACOEFS    (:,1) double  {mustBeNumeric}                        = [320 0.111 4.79e-4 1] % Coefficients for OKAWA entrainment model, default to 2003
    ...
    methods
        function obj = Model(filePath,modelID)
            ...
            if length(obj.OKAWACOEFS) < 4 || mod(length(obj.OKAWACOEFS), 2) ~= 0
                throw( ...
